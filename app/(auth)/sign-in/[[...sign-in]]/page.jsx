    ...
    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      ...
      <div className="hidden lg:relative lg:block lg:p-12">
        ...
        <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
          Welcome to Interview Pro 🤖🎤–<br/>
          AI-Powered Mock Interview Platform
        </h2>

        <p className="mt-4 text-lg leading-relaxed text-white/90">
        InterviewPro is an AI-driven mock interview platform designed to help users improve their interview skills with real-time AI feedback, speech-to-text analysis, and audio-video recording.<br/>

<b>🚀 Key Features:</b><br/>
✅ AI-Powered Mock Interviews – Practice with role-specific questions.<br/>
✅ Real-Time AI Feedback – Get ratings and improvement suggestions.<br/>
